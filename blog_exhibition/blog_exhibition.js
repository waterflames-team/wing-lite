...
function make_body_begin(author,headURL,introduce)
{
    ...
    return '<div class=\"container-fluid\"><div class=\"row\"><nav class=\"col-md-2 d-none d-md-block bg-light sidebar\"><div class=\"sidebar-sticky\"></div></nav></div><div class=\"container-fluid\"><div class=\"row\"><nav class=\"col-md-2 d-none d-md-block bg-light sidebar\"><div class=\"sidebar-sticky\"></div></nav></div><div class=\"container-fluid\"><div class=\"row\"><nav class=\"col-md-2 d-none d-md-block bg-light sidebar\"><div class=\"sidebar-sticky\"></div></nav></div><!--head、small--><br><div class=\"alert alert-primary\" role=\"alert\"><h4 class=\"alert-heading\">'+ author +'的博客</h4><hr><p>欢迎来到'+ author +'的博客</p><p>这里就是博客的首页了</p></div><br><div class="alert alert-info" role="alert"><h4 class="alert-heading"><img src="'+ headURL +'" alt="" width="70px" class="rounded-circle">'+ author +'</h4><hr><p>'+ introduce +'</p></div><div class="container-fluid"><div class="row"><main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">';
}
